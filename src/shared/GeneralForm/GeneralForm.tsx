...
import { SortableSubtaskList } from '../../modules/TaskSection/TaskModal/SortableSubtaskList/SortableSubtaskList';
...
export const GeneralForm = memo(
  ({ task, isEdit, handleSubmit, handleDelete }: GeneralFormProps) => {
